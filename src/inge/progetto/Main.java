...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String operatore;
        do {
            operatore = InputDati.leggiStringa("Selezionare il tipo di Utente: (manutentore/fruitore)\n");
        } while (!operatore.equals("manutentore") && !operatore.equals("fruitore"));
                                ...
                                if (cat.getNome().equals(categoria)) {
                                    ...
                                    for (ModalitaOperativa mod : listaModalitaOperative) {
                                        if (mod.getNome().equals(statoAttuale)) {
                                            listaAttuatori.add(new Attuatore(nuovoAttuatore, cat, statoAttuale));
                    ...
                    case 10:
                        ...
                        for (Artefatto arte : unitaImmobiliare.getListaArtefatti()) {
                            if (arte.getNome().equals(artefatto)) {
                                ...
                                String sensore = InputDati.leggiStringa("Inserisci il nome del sensore da aggiungere all'artefatto: ");
                                ...
                                String attuatore = InputDati.leggiStringa("Inserisci il nome dell' attuatore da aggiungere all'artefatto: ");
